...
('catalog-postgresql',       '[{"service":{"id":"postgresql"},"internal":5432,"external":6079}]'::json, '[]'::json, 'usr-20151006-1'),
('organization',             '[{"service":{"id":"play"},"internal":9000,"external":6081}]'::json, '["user", "organization-postgresql"]'::json, 'usr-20151006-1'),
('organization-postgresql',  '[{"service":{"id":"postgresql"},"internal":5432,"external":6089}]'::json, '[]'::json, 'usr-20151006-1'),
